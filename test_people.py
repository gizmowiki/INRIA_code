...
'''
base_out_path = "/data/stars/user/rpandey/output_ktp_fit_alexnet_large"
TestData(filelist_path='/home/rpandey/files_ktp_sorted.txt', base_out_path=base_out_path, annotation_dict=annotations_dict, image_enhancement=[False, False], predict_threshold=0.9, nms_threshold=0.5, ed_bx_threshold=0.75)
