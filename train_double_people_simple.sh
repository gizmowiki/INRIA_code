...
# cd /local/people_depth/negatives/

# find `pwd` -maxdepth 2 -type f -name "*.png"| head -80000> ../files_negative.txt

# find `pwd` -maxdepth 2 -type f -name "*.png"| head -965612> ../files_negative.txt
# find `pwd` -maxdepth 2 -type f -name "*.jpg"| head -40000> ../files_negative.txt

/usr/bin/python /home/rpandey/people_detect/simple_people_depth.py
